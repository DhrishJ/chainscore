'use client'
// The wagmi half of the notification bell. Only import dynamically (see
// NotificationBell.tsx): a static import would pull wagmi back onto the
// critical path (D-032).
...
export default function NotificationBellInner() {
